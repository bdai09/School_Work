...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db1) {
		db1.execSQL(
						"CREATE TABLE items (id INTEGER PRIMARY KEY, name0 TEXT, name1 TEXT, name2 TEXT,name3 TEXT,name4 TEXT )"
		);
	}
	...
	public List<String> getAllItems0() {
		...
		if (cursor.moveToFirst()) {
			do {
				listItems2.add(cursor.getString(1));
	...
	public List<String> getAllItems1() {
		...
		if (cursor.moveToFirst()) {
			do {
				listItems2.add(cursor.getString(2));
			} while (cursor.moveToNext());
		}
	...
	public List<String> getAllItems2() {
		...
		if (cursor.moveToFirst()) {
			do {
				listItems2.add(cursor.getString(3));
			} while (cursor.moveToNext());
		}
	...
	public List<String> getAllItems3() {
		...
		if (cursor.moveToFirst()) {
			do {
				listItems2.add(cursor.getString(4));
			} while (cursor.moveToNext());
		}
	...
	public List<String> getAllItems4() {
		...
		if (cursor.moveToFirst()) {
			do {
				listItems2.add(cursor.getString(5));
			} while (cursor.moveToNext());
		}
